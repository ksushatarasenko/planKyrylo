const data = {
  ...
  hobby: {
    title: "Хобби",
    text: "Делай то, что тебе нравится 🎮🎨",
    text2: "Хобби развивает твоё мышление и воображение.",
    text3: "Когда тебе интересно — ты растёшь быстрее!"
  },

  walk: {
    title: "Приключение",
    text: "Найди 5 интересных вещей 👀",
    text2: "Это может быть: птица, растение, звук, насекомое или что-то необычное.",
